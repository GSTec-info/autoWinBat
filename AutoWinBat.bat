...
if %op%==s (mkdir "%destino%" & if exist "%destino%" (echo ---- Pasta %destino% criada!! & GOTO continua_COPIA_ROBOCOPY ) else (echo ---- Erro na cria‡Æo da pasta & timeout 5 & GOTO COPIA_ROBOCOPY))
